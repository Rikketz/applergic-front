...
import './DocumentTranslated2.scss';

export default function DocumentTranslated2() {
    ...
    <div className="documentTranslatedMainDiv">
        ...
        <div onClick={priorDoc}><p className="documentTranslatedMainDiv--nextDoc"><DocumentTranslator codIdioma={codIdioma} texto1={'Ir a informe anterior'} /></p></div>
    </div>
    </>);
}
